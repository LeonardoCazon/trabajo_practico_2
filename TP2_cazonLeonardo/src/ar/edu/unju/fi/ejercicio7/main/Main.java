...
import ar.edu.unju.fi.ejercicio7.model.Categoria;
import ar.edu.unju.fi.ejercicio7.model.Origen;
		...
		do {
			try {
				...
				case 1:
					...
					break;
				case 2:
					Predicate<Producto> predicProd = p -> !p.isStock() ;
				...
				case 4:
					...
					break;
				case 5:
					ArrayList<Producto> ordenada = new ArrayList<>();
